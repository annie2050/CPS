...
function OrderBooking() {
  ...
  const [activePage, setActivePage] = useState('orderbooking')
    ...
    try {
      ...
      const res = await fetch('/api/dashboard/orders', {
        ...
        body: JSON.stringify({
          ...
          productName: selectedProduct?.ProductN || selectedProduct?.productName || '',
      ...
      <div className="order-page-main">
        ...
        <div className="order-page-content">
          <div className="order-form-card">
            <h2 className="order-form-title">Order Booking - {user?.name}</h2>
                ...
                <div className="order-form-grid">
                  ...
                  <div className="order-form-group">
                    ...
                    >
                      ...
                      {units.map((u) => (
                        <option key={u.unqid} value={u.unqid}>{u.unitName || u.unit}</option>
                      ))}
                    </select>
                  </div>
